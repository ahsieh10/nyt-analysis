...
export const mockSuccessResponse: APISuccessResponse = {
  ...
  data: {
    articles: [
      {
        ...
        snippet:
          "As Xi Jinping and the Communist Party further exercise control over the economy, the financial sector is coming under close scrutiny.",
        thumbnail:
          "images/2023/04/25/multimedia/00China-Finance-Crackdown-01-bvhw/00China-Finance-Crackdown-01-bvhw-thumbStandard.jpg",
        webUrl:
          "https://www.nytimes.com/2023/04/27/business/china-banker-crackdown.html",
        wordCount: 1149,
      },
      {
        headline: "Biden Meets Marcos in Washington Amid Tensions With China",
        keywords: [
          "Marcos, Ferdinand Jr",
          "Biden, Joseph R Jr",
        ...
        snippet:
          "The Filipino leader’s four-day visit is meant to send a message to China amid conflict over Taiwan and the South China Sea.",
        thumbnail:
          "images/2023/05/01/multimedia/01dc-prexy-sub-pltb/01dc-prexy-sub-pltb-thumbStandard.jpg",
        webUrl:
      ...
      },
      {
        ...
        snippet:
          "Li Yanhe’s publishing company put out books that often cast a critical eye on China’s ruling Communist Party. He disappeared while on a trip to China.",
        thumbnail:
          "images/2023/04/29/multimedia/29CHINA-TAIWAN-jqcp/29CHINA-TAIWAN-jqcp-thumbStandard.jpg",
        webUrl:
      ...
      },
      {
        ...
        snippet:
          "Star sellers can amass huge followings and eye-popping fortunes, through a format that mixes consumerism and entertainment. But competition is fierce, and the government is watching.",
        thumbnail:
          "images/2023/04/26/multimedia/00china-livestream-10-pzkt/00china-livestream-10-pzkt-thumbStandard.jpg",
        webUrl:
          "https://www.nytimes.com/2023/04/28/business/china-livestreaming-ecommerce.html",
        wordCount: 2663,
      },
      {
        headline: "China Says Chatbots Must Toe the Party Line",
        keywords: [
        ...
        snippet:
          "The Communist Party outlined draft rules that would set guardrails on the rapidly growing industry of services like ChatGPT.",
        thumbnail:
          "images/2023/04/24/multimedia/24china-ai-01-jhct/24china-ai-01-jhct-thumbStandard.jpg",
        webUrl:
          "https://www.nytimes.com/2023/04/24/world/asia/china-chatbots-ai.html",
        wordCount: 1181,
      },
      {
        headline: "Chinese Censorship Is Quietly Rewriting the Covid-19 Story",
        keywords: [
          "China",
        ...
        snippet:
          "Under government pressure, Chinese scientists have retracted studies and withheld or deleted data. The censorship has stymied efforts to understand the virus.",
        thumbnail:
          "images/2023/04/11/multimedia/00covid-censorship-04-hqpm/00covid-censorship-04-hqpm-thumbStandard.jpg",
        webUrl:
          "https://www.nytimes.com/2023/04/23/world/europe/chinese-censorship-covid.html",
        wordCount: 2131,
      },
      {
        headline: "Ex-Harvard Professor Sentenced in China Ties Case",
        keywords: [
          "your-feed-science",
        ...
        snippet:
          "Charles Lieber had been seen as a potential Nobel Prize-winning chemist, but was convicted in 2021 of lying to federal investigators and failing to report income.",
        thumbnail:
          "images/2023/04/26/multimedia/26lieber-vkfj/26lieber-vkfj-thumbStandard.jpg",
        webUrl:
          "https://www.nytimes.com/2023/04/26/science/charles-lieber-sentence-china.html",
        wordCount: 583,
      },
      {
        headline: "Yellen Calls for ‘Constructive’ China Relationship",
        keywords: [
          "China",
          "United States International Relations",
        ...
        thumbnail: "",
        webUrl:
          "https://www.nytimes.com/2023/04/20/business/economy/yellen-us-china-relationship.html",
        wordCount: 978,
      },
      {
        headline:
        ...
        snippet:
          "Remarks by China’s ambassador to France questioning the sovereignty of ex-Soviet states threatened to upset China’s efforts to balance courting Europe with supporting Russia.",
        thumbnail:
          "images/2023/04/24/multimedia/24ukraine-briefing-china-01-kqtl/24ukraine-briefing-china-01-kqtl-thumbStandard.jpg",
        webUrl:
          "https://www.nytimes.com/2023/04/24/world/europe/china-ambassador-soviet-states.html",
        wordCount: 1284,
      },
      {
        headline:
        ...
        snippet:
          "Researchers from the Citizen Lab, a cybersecurity research group, found that the most diligent censor in China is Microsoft’s search engine Bing, the only foreign search engine operating in the country.",
        thumbnail:
          "images/2023/04/26/multimedia/26China-Microsoft-Censors-tmbh/26China-Microsoft-Censors-tmbh-thumbStandard.jpg",
        webUrl:
    ...
    biased: [
      "Early in 2020 on the same day that a frightening new illness officially got the name Covid 19 a team of scientists from the United States and China released critical data showing how quickly the virus was spreading and who was dying.",
      "Charles Lieber a former Harvard chemistry professor was sentenced on Tuesday for making false statements to the U.S.",
      "government and for failing to declare large sums of money he’d been paid as part of a contract with a Chinese program Thousand Talents and Wuhan University in China.",
      ...
      "— A Taiwan based publisher who disappeared while in China has been detained for suspected violations of security laws Chinese authorities confirmed on Wednesday fanning concerns in Taiwan that Beijing is sending a warning to the island’s vibrant publishing sector.",
      "For years Xi Jinping China’s leader has railed against greed and corruption in the country’s financial sector making an example of a few prominent figures along the way.",
      "WASHINGTON",
      "— President Biden met with President Ferdinand R. Marcos Jr.",
      "TAIPEI Taiwan",
      "The yurt stood in the middle of a sweeping northern Chinese grassland beneath a cloudless sky.",
      "A reedy folk tune played.",
      "Nearby sheep grazed.",
      "WASHINGTON",
      "BRUSSELS",
      "Five months after ChatGPT set off an investment frenzy over artificial intelligence Beijing is moving to rein in China’s chatbots a show of the government’s resolve to keep tight regulatory control over technology that could define an era.",
      "of the Philippines at the White House on Monday a visit meant to send a message to China that the Filipino leader planned to deepen his country’s relationship with the United States.",
      "China’s internet censorship is well known but a report has quantified the extent of it uncovering more than 66 000 rules controlling the content that is available to people using search engines.",
      "— Treasury Secretary Janet L. Yellen on Thursday called for a “constructive” and “healthy” economic relationship between the United States and China one in which the two nations could work together to confront global challenges in spite of their conflicting national security interests.",
    ],
    sentiment: "N",
  },
};
