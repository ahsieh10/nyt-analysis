                ...
                <Scrollbars height="75vh" width="35vw" autoHide>
                  ...
                  <div className="about-body" role="about-body">
                    <p>
                      ...
                      model in order to conduct a sentiment analysis on the top
                      10 articles related to the topic that you searched for.
                      <br></br>
                      <br></br>
                      ...
                      model has computed, examples of most biased sentences
                      within the articles analyzed, as well as a keyword word
                      cloud that highlights notable words & phrases commonly
                      used for the given topic. We also provide the analyzed
                      article links for reference.
                      <br></br>
                      <br></br>
                      ...
                      <br></br>
                      <br></br>
                      DISCLAIMER: User search queries are cached and stored in
                      the website's system in order to gather data about common
                      topics. Personalized data or any identifying information
